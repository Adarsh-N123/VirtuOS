...
def scan(sequence , head , direction , disk_size):
    ...
    if (direction == "LEFT"): 
        ...
        total_seek_time = head + right_track[-1]
        ...
        total_seek_time = disk_size-head + disk_size-left_track[-1]
    
    return sequence_track , total_seek_time 

def cscan(sequence , head , direction , disk_size):
    pass 
...
print(scan(queue,head,"RIGHT",disk_size))
